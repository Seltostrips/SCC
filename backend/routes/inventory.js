...
const { checkDBConnection } = require('../middleware/db'); // IMPORTED from the new middleware file

// REMOVE the local definition of checkDBConnection here, as it's now imported
